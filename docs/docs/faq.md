...
The editor is a self-hosted Spring Boot application. When you click "Generate Policy," the request is processed by the local instance of the application. No sensitive data or policies are sent to Philterd's servers.
