...
The editor is a self-hosted Spring Boot application. When you click "Generate Policy," the request is processed by the local instance of the application. Data is not sent to any third-party server.
